        ...
        <div className={navbarStyles.blackLine}></div>
            <ul className={navbarStyles.ul}>
                <li className={navbarStyles.li} style={ firstActive? {"border": "3px solid black"} : {'border': 'none'}}>
                    <ScrollLink to="1" spy={true} smooth={true} duration={500} offset={-200} onSetActive={() => setFirstActive(true)} onSetInactive={() => setFirstActive(false)}>
                ...
                <li className={navbarStyles.li} style={ secondActive? {"border": "3px solid black"} : {'border': 'none'}}>
                    <ScrollLink to="2" spy={true} smooth={true} duration={500} offset={-200} onSetActive={() => setSecondActive(true)} onSetInactive={() => setSecondActive(false)}>
                ...
                <li className={navbarStyles.li} style={ thirdActive? {"border": "3px solid black"} : {'border': 'none'}}>
                    <ScrollLink to="3" spy={true} smooth={true} duration={500} offset={-50} onSetActive={() => setThirdActive(true)} onSetInactive={() => setThirdActive(false)}>
